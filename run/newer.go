...
var errNewer = errors.New("newer item encountered")
...
// OldestModTime recurses a list of target filesystem objects and
// finds the oldest ModTime among them.
...
// NewestModTime recurses a list of target filesystem objects and
// finds newest ModTime among them.
