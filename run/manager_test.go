...
MyThing                         MyThing for unittesting.
- MyThing:Test123               Docs for Test123.
- MyThing:TestWithDep           Docs for TestWithDep.
- MyThing:TestWithDepErr        Docs for TestWithDepErr.
- MyThing:TestWithDepMustPanic  Docs for TestWithDepMustPanic.
- MyThing:ValueReceiver         Docs for ValueReceiver.
`, string(tookRegEx.ReplaceAll(stdoutBuf.Bytes(), nil)))
}
