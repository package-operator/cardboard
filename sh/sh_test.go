...
func TestRunner_Run(t *testing.T) {
	t.Parallel()
	log := slogt.New(t)
	err := sh.New(sh.WithLogger{log}).Run("echo")
...
func TestRunner_Run_error(t *testing.T) {
	t.Parallel()
	log := slogt.New(t)
	err := sh.New(sh.WithLogger{log}).Run("bash", "-c", "false")
...
func TestRunner_Run_runerror(t *testing.T) {
	t.Parallel()
	log := slogt.New(t)
	err := sh.New(sh.WithLogger{log}).Run("xxxxxxxxxxx")
...
func TestRunner_Output(t *testing.T) {
	t.Parallel()
	log := slogt.New(t)
	out, err := sh.New(sh.WithLogger{log}).Output("echo", "hello world")
	require.NoError(t, err)
